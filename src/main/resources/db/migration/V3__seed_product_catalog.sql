-- ============================================================
-- V3: Seed the product catalogue
-- Replaces the old src/main/resources/data.sql
-- ============================================================

INSERT INTO products (id, name, category, price, stock_quantity, version)
VALUES (1, 'iPhone 15', 'Smartphone', 65000.00, 10, 0),
